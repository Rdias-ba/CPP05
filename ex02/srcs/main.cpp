...
/*   Updated: 2024/10/11 17:16:08 by rdias-ba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		std::cout << "\n\033[32m-----------------------------------------------------------------------------------\033[0m" << std::endl;
  		std::cout << "\033[32mTesting try and catch with Lowest graded Bureaucrat signing Forms :\033[0m" << std::endl;
		...
		AForm *c = new RobotomyRequestForm("default");
		AForm *d = new ShrubberyCreationForm("default");
		...
		{
			std::cerr << "\033[31m" << a->getName() << " was not able to sign " << c->getName() << ": " << e.what() << "\033[0m" << std::endl;
		}
		std::cout << c << std::endl;
		...
		{
			std::cerr << "\033[31m" << a->getName() << " was not able to sign " << d->getName() << ": " << e.what() << "\033[0m" << std::endl;
		}
		std::cout << d << std::endl;
...

	{
		...
		PresidentialPardonForm *b = new PresidentialPardonForm("Jhon");
